...
export function findCorrections(text, charts) {
  ...
  for (const notice of notices) {
    for (const chart of charts) {
      ...
      // and look up their names in the CAL to match against folio chart names.
      // e.g., notice mentions "Chart 5614_4" → CAL says "Approaches to Great Yarmouth"
      // → extractCore gives "Great Yarmouth" → matches folio chart 1534 "Great Yarmouth and Approaches"
      let panelBase = null;
